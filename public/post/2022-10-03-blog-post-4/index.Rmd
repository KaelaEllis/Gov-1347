...
Although some say that incorporating expert polls is "cheating", expert polls are highly accurate and most incorporate the incumbency advantage, since the districts that have long-standing incumbents are usually categorized as "safe" by experts. Therefore, I did not incorporate incumbency into my prediction. However, when I remove expert polls from my forecast, I will make an incumbency factor. My prediction remains that Republicans will receive 51.39% of the vote share
